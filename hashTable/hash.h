...
// do not change anything above!
   ...
   int totalElements;     // total number of elements of hash table
   double currentAvgListLen; // current average list length of a hash table
   int nonEmptyLists;   // number of non empty lists present in a hash table
};
